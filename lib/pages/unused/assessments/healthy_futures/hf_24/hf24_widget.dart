...
import 'hf24_model.dart';
export 'hf24_model.dart';

class Hf24Widget extends StatefulWidget {
  const Hf24Widget({super.key});

  @override
  State<Hf24Widget> createState() => _Hf24WidgetState();
}

class _Hf24WidgetState extends State<Hf24Widget> {
  late Hf24Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hf24Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'hf_24'});
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text:
                                      'Do you know your exact total cholesterol value?',
                            ...
                            if (_model.dropDownValue == 'mg/dL') {
                              ...
                              if (!functions.isWithinString(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Total cholesterol input must be between 1 and 1250 mg/dL.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
                              ...
                              if (!functions.isWithinString(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Total cholesterol input must be between 0.1 and 35 mmol/L.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
