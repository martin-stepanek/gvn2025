          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('CHAT_ENHANCED_PAGE_Icon_7ua0mewq_ON_TAP');
                                                    ...
                                                    child: SelectGenderWidget(
                                                      action: () async {
                                                        ...
                                                        await MessagesRecord
                                                          ...
                                                          firstMessage: false,
                                                          message:
                                                              'Using ${currentUserDocument?.gender?.name} as your gender.',
                                                          user: User.coach,
                                                          userRef:
