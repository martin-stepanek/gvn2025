                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_PAGE_linkTracker_ON_TAP');
                              var shouldSetState = false;
                              if (valueOrDefault<bool>(
                                  currentUserDocument?.trackerLinked, false)) {
                                logFirebaseEvent('linkTracker_show_snack_bar');
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Tracker already linked.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
                                ...
                                logFirebaseEvent('linkTracker_custom_action');
                                ...
                                if (_model.appleHealthSuccess!) {
                                  logFirebaseEvent('linkTracker_backend_call');
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_PAGE_refreshData_ON_TAP');
                              if (valueOrDefault<bool>(
                                  currentUserDocument?.appleHealthLinked,
                                  false)) {
                                logFirebaseEvent('refreshData_custom_action');
                                ...
                                logFirebaseEvent(
                                    'refreshData_update_page_state');
                                _model.loopIndex = 0;
                                safeSetState(() {});
                                while (_model.loopIndex! <
                                    _model.appleHealthData!.length) {
                                  logFirebaseEvent('refreshData_backend_call');

                                  await CombinedDataRecord.createDoc(
                                          currentUserReference!)
                                      .set(createCombinedDataRecordData(
                                    createdAt: getCurrentTimestamp,
                                    eventDate: (_model.appleHealthData
                                            ?.elementAtOrNull(
                                                _model.loopIndex!))
                                        ?.eventDate,
                                    source: (_model.appleHealthData
                                            ?.elementAtOrNull(
                                                _model.loopIndex!))
                                        ?.sourceId,
                                    combinedData: updateCombinedDataStruct(
                                      _model.appleHealthData
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'You must link an activity tracker first.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_PAGE_unlinkTracker_ON_TAP');
                              logFirebaseEvent('unlinkTracker_backend_call');
