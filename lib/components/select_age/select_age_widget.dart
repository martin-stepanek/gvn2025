...
import 'select_age_model.dart';
export 'select_age_model.dart';

class SelectAgeWidget extends StatefulWidget {
  const SelectAgeWidget({
    super.key,
...
class _SelectAgeWidgetState extends State<SelectAgeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectAgeModel());
          ...
          children: [
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SELECT_AGE_COMP_Next_ON_TAP');
                  ...
                  await currentUserReference!.update(createUsersRecordData(
                    age: double.tryParse(_model.textController.text),
                  ));
