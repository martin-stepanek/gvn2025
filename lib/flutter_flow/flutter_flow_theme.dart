...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF41C5E);
  late Color secondary = const Color(0xFFFA638F);
  ...
  late Color accent1 = const Color(0xFF5AB6B2);
  late Color accent2 = const Color(0xFFEDAD3F);
  late Color accent3 = const Color(0xFF868989);
  late Color accent4 = const Color(0xFFD9D9D9);
  late Color success = const Color(0xFF4BA564);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color lineColor = const Color(0xFFE0E3E7);
  late Color lightGrey = const Color(0xFFF5F4F4);
}
